...
import net.arwix.astronomy.ephemeris.Nutation
...
class RiseSetCalculatorTest {
    ...
    fun calls() {
        ...
        objGeoEcliptic = net.arwix.astronomy.ephemeris.precession.Precession.JPL_DE4xx(t).transformFromJ2000(objGeoEcliptic)
