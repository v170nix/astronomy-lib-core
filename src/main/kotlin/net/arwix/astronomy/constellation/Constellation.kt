...
object Constellation {
    ...
    val CONSTELLATION_ABBREV = arrayOf("And", "Ant", "Aps", "Aql", "Aqr", "Ari", "Ara", "Aur", "Boo", "Cae", "Cam", "CnC", "Cap", "Car", "Cas", "Cen", "Cep", "Cet", "Cha", "Cir", "CMa", "CMi", "Cnc", "Col", "Com", "CrA", "CrB", "Crt", "Cru", "Crv", "CVn", "Cyg", "Del", "Dor", "Dra", "Equ", "Eri", "For", "Gem", "Gru", "Her", "Hor", "Hya", "Hyi", "Ind", "Lac", "Leo", "Lep", "Lib", "LMi", "Lup", "Lyn", "Lyr", "Men", "Mic", "Mon", "Mus", "Nor", "Oct", "Oph", "Ori", "Pav", "Peg", "Per", "Phe", "Pic", "PsA", "Psc", "Pup", "Pyx", "Ret", "Scl", "Sco", "Sct", "Ser", "Sex", "Sge", "Sgr", "Tau", "Tel", "Tra", "Tri", "Tyc", "UMa", "UMi", "Vel", "Vir", "Vol", "Vul", "Ser")
     ...
     * @param vector Object position, should be mean astrometric referred to certain epoch.
     * @return Constellation Latin name.
     * @throws Exception If the calculation fails.
     */
    fun getAbbreviationJ2000(vectorJ2000: Vector): String {

        val T = getJT(5888.75855)
        val vector = Precession.IAU2009(T).transformFromJ2000(vectorJ2000).toType<SphericalVector>()
        val ra = vector.phi.normalize() * 43200.0 / Math.PI
        val dec = vector.theta * RAD_TO_ARCSEC
        ...
        throw Exception("constellation not found")
    }


    fun getAbbreviationApparent(vector: SphericalVector, nutation: Nutation, precession: Precession): String {
        if (precession.isEcliptic) throw IllegalArgumentException("Precession is Ecliptic")
        return getAbbreviationJ2000(
                nutation.removeNutationFromEquatorialVector(vector).let(precession::transformToJ2000))
    }

    fun getAbbreviationApparent(vector: SphericalVector,
                                nutation: Nutation,
                                precession: Precession,
                                obliquity: Obliquity? = null): String {
        if (precession.isEcliptic && obliquity == null) throw IllegalArgumentException("Precession is Ecliptic and obliquity null")
        return getAbbreviationJ2000(
                nutation.removeNutationFromEquatorialVector(vector)
                        .letIf(precession.isEcliptic, obliquity!!::rotateFromEquatorialToEcliptic)
                        .let(precession::transformToJ2000)
                        .letIf(precession.isEcliptic, precession.getNearestObliquityModel(0.0)::rotateFromEclipticToEquatorial))
